...
INVERTER_EQUIVALENTS = {
    ...
    "XOR2": 4.0,  # 8T / 2T = 4.0 Inverters
    "XNOR2": 4.0, # 8T / 2T = 4.0 Inverters
    "MUX2": 3.0,  # 6T / 2T = 3.0 Inverters
    "AOI21": 3.0, # 6T / 2T = 3.0 Inverters
    "OAI21": 3.0, # 6T / 2T = 3.0 Inverters
    "DFFR": 8.0,  # 16T / 2T = 8.0 Inverters
    "DFFS": 8.0,  # 16T / 2T = 8.0 Inverters
    "DFF": 8.0,   # 16T / 2T = 8.0 Inverters
}
