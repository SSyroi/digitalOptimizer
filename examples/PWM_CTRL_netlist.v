...
// Inverter Equivalents  : 319.0 GE
// Transistor Count     : 638 transistors
// ============================================================================
...
module PWM_CTRL_netlist (VDD, VSS, sub, res_n, c_DfT_en_LP, c_DfT_en_PWM, c_DfT_oc_dig_VDD, en_LP, oc_select, oc_ctrl_cp, oc_ctrl_bgr, clk_i, en_lowFreq, oc_select_ext, oc_ctrl_cp_ext, en_LP_ext, c_metalFix_invert_oc_defaults);
  ...
  // Shared Intermediate Product Term Wires (52 unique shared cubes)
  wire w_c0, w_c1, w_c2, w_c3, w_c4, w_c5, w_c6, w_c7, w_c8, w_c9, w_c10, w_c11, w_c12, w_c13, w_c14, w_c15, w_c16, w_c17, w_c18, w_c19, w_c20, w_c21, w_c22, w_c23, w_c24, w_c25, w_c26, w_c27, w_c28, w_c29, w_c30, w_c31, w_c32, w_c33, w_c34, w_c35, w_c36, w_c37, w_c38, w_c39, w_c40, w_c41, w_c42, w_c43, w_c44, w_c45, w_c46, w_c47, w_c48, w_c49, w_c50, w_c51;
  ...
  // 2. Shared Intermediate Product Term Gates (52 unique NAND cells)
  // Shared: oc_select, oc_ctrl_bgr_d
  NAND4_X1 U_c0 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_oc_dig_VDD[1]), .C(w_inv_c_DfT_oc_dig_VDD_0), .D(c_metalFix_invert_oc_defaults), .Y(w_c0));
  // Shared: oc_select, oc_ctrl_bgr_d
  NAND4_X1 U_c1 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_oc_dig_VDD_1), .C(c_DfT_oc_dig_VDD[0]), .D(w_inv_c_metalFix_invert_oc_defaults), .Y(w_c1));
  // Output: oc_select
  NAND3_X1 U_c2 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_oc_dig_VDD_1), .C(c_metalFix_invert_oc_defaults), .Y(w_c2));
  // Output: oc_select
  NAND3_X1 U_c3 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_oc_dig_VDD[1]), .C(w_inv_c_metalFix_invert_oc_defaults), .Y(w_c3));
  // Output: oc_ctrl_cp
  NAND4_X1 U_c4 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_oc_dig_VDD[1]), .C(w_inv_c_metalFix_invert_oc_defaults), .D(w_inv_oc_ctrl_bgr_q), .Y(w_c4));
  // Output: oc_ctrl_cp
  NAND4_X1 U_c5 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_oc_dig_VDD_0), .C(c_metalFix_invert_oc_defaults), .D(w_inv_oc_ctrl_bgr_q), .Y(w_c5));
  // Output: oc_ctrl_cp
  wire w_c6_n0, w_c6_i0;
  NAND4_X1 U_c6_n0 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_oc_dig_VDD[1]), .C(c_DfT_oc_dig_VDD[0]), .D(c_metalFix_invert_oc_defaults), .Y(w_c6_n0));
  INV_X1 U_c6_inv0 (.A(w_c6_n0), .Y(w_c6_i0));
  wire w_c6_n1, w_c6_i1;
  INV_X1 U_c6_n1 (.A(oc_ctrl_bgr_q), .Y(w_c6_n1));
  INV_X1 U_c6_inv1 (.A(w_c6_n1), .Y(w_c6_i1));
  NAND2_X1 U_c6_root (.A(w_c6_i0), .B(w_c6_i1), .Y(w_c6));
  // Output: oc_ctrl_cp
  NAND4_X1 U_c7 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_oc_dig_VDD_1), .C(c_DfT_oc_dig_VDD[0]), .D(w_inv_oc_ctrl_bgr_q), .Y(w_c7));
  // Output: oc_ctrl_cp
  wire w_c8_n0, w_c8_i0;
  NAND4_X1 U_c8_n0 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_en_PWM), .C(w_inv_cnt_3_q), .D(w_inv_cnt_2_q), .Y(w_c8_n0));
  INV_X1 U_c8_inv0 (.A(w_c8_n0), .Y(w_c8_i0));
  wire w_c8_n1, w_c8_i1;
  NAND4_X1 U_c8_n1 (.A(w_inv_cnt_1_q), .B(cnt_0_q), .C(startup_q), .D(w_inv_oc_ctrl_bgr_q), .Y(w_c8_n1));
  INV_X1 U_c8_inv1 (.A(w_c8_n1), .Y(w_c8_i1));
  NAND2_X1 U_c8_root (.A(w_c8_i0), .B(w_c8_i1), .Y(w_c8));
  // Output: oc_ctrl_cp
  wire w_c9_n0, w_c9_i0;
  NAND4_X1 U_c9_n0 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_oc_dig_VDD_1), .C(w_inv_c_DfT_oc_dig_VDD_0), .D(w_inv_c_metalFix_invert_oc_defaults), .Y(w_c9_n0));
  INV_X1 U_c9_inv0 (.A(w_c9_n0), .Y(w_c9_i0));
  wire w_c9_n1, w_c9_i1;
  INV_X1 U_c9_n1 (.A(oc_ctrl_bgr_q), .Y(w_c9_n1));
  ...
  NAND3_X1 U_c10_n1 (.A(c_metalFix_invert_oc_defaults), .B(cnt_1_q), .C(w_inv_cnt_0_q), .Y(w_c10_n1));
  ...
  NAND3_X1 U_c11_n1 (.A(c_metalFix_invert_oc_defaults), .B(w_inv_cnt_0_q), .C(w_inv_startup_q), .Y(w_c11_n1));
  INV_X1 U_c11_inv1 (.A(w_c11_n1), .Y(w_c11_i1));
  NAND2_X1 U_c11_root (.A(w_c11_i0), .B(w_c11_i1), .Y(w_c11));
  // Shared: en_lowFreq, oc_ctrl_bgr_d
  wire w_c12_n0, w_c12_i0;
  NAND4_X1 U_c12_n0 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_en_PWM), .C(c_DfT_oc_dig_VDD[1]), .D(c_DfT_oc_dig_VDD[0]), .Y(w_c12_n0));
  INV_X1 U_c12_inv0 (.A(w_c12_n0), .Y(w_c12_i0));
  wire w_c12_n1, w_c12_i1;
  NAND3_X1 U_c12_n1 (.A(c_metalFix_invert_oc_defaults), .B(cnt_2_q), .C(w_inv_cnt_0_q), .Y(w_c12_n1));
  ...
  NAND3_X1 U_c13_n1 (.A(w_inv_c_metalFix_invert_oc_defaults), .B(cnt_3_q), .C(w_inv_cnt_0_q), .Y(w_c13_n1));
  ...
  NAND3_X1 U_c14_n1 (.A(c_metalFix_invert_oc_defaults), .B(cnt_3_q), .C(w_inv_cnt_0_q), .Y(w_c14_n1));
  INV_X1 U_c14_inv1 (.A(w_c14_n1), .Y(w_c14_i1));
  NAND2_X1 U_c14_root (.A(w_c14_i0), .B(w_c14_i1), .Y(w_c14));
  // Shared: en_lowFreq, oc_ctrl_bgr_d
  wire w_c15_n0, w_c15_i0;
  NAND4_X1 U_c15_n0 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_en_PWM), .C(w_inv_c_DfT_oc_dig_VDD_1), .D(w_inv_c_DfT_oc_dig_VDD_0), .Y(w_c15_n0));
  INV_X1 U_c15_inv0 (.A(w_c15_n0), .Y(w_c15_i0));
  wire w_c15_n1, w_c15_i1;
  NAND3_X1 U_c15_n1 (.A(w_inv_c_metalFix_invert_oc_defaults), .B(w_inv_cnt_0_q), .C(w_inv_startup_q), .Y(w_c15_n1));
  INV_X1 U_c15_inv1 (.A(w_c15_n1), .Y(w_c15_i1));
  NAND2_X1 U_c15_root (.A(w_c15_i0), .B(w_c15_i1), .Y(w_c15));
  // Output: en_lowFreq
  NAND3_X1 U_c16 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_en_PWM), .C(en_LP_q), .Y(w_c16));
  // Shared: en_lowFreq, oc_ctrl_bgr_d
  ...
  NAND3_X1 U_c17_n1 (.A(w_inv_c_metalFix_invert_oc_defaults), .B(cnt_2_q), .C(w_inv_cnt_0_q), .Y(w_c17_n1));
  INV_X1 U_c17_inv1 (.A(w_c17_n1), .Y(w_c17_i1));
  NAND2_X1 U_c17_root (.A(w_c17_i0), .B(w_c17_i1), .Y(w_c17));
  // Shared: en_lowFreq, oc_ctrl_bgr_d
  wire w_c18_n0, w_c18_i0;
  NAND4_X1 U_c18_n0 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_en_PWM), .C(w_inv_c_DfT_oc_dig_VDD_1), .D(w_inv_c_DfT_oc_dig_VDD_0), .Y(w_c18_n0));
  INV_X1 U_c18_inv0 (.A(w_c18_n0), .Y(w_c18_i0));
  wire w_c18_n1, w_c18_i1;
  NAND3_X1 U_c18_n1 (.A(w_inv_c_metalFix_invert_oc_defaults), .B(cnt_1_q), .C(w_inv_cnt_0_q), .Y(w_c18_n1));
  INV_X1 U_c18_inv1 (.A(w_c18_n1), .Y(w_c18_i1));
  NAND2_X1 U_c18_root (.A(w_c18_i0), .B(w_c18_i1), .Y(w_c18));
  // Output: cnt[3]_d
  NAND4_X1 U_c19 (.A(w_inv_cnt_3_q), .B(cnt_2_q), .C(cnt_1_q), .D(cnt_0_q), .Y(w_c19));
  // Output: cnt[3]_d
  NAND2_X1 U_c20 (.A(cnt_3_q), .B(w_inv_cnt_0_q), .Y(w_c20));
  // Output: cnt[3]_d
  NAND2_X1 U_c21 (.A(cnt_3_q), .B(w_inv_cnt_2_q), .Y(w_c21));
  // Output: cnt[3]_d
  NAND2_X1 U_c22 (.A(cnt_3_q), .B(w_inv_cnt_1_q), .Y(w_c22));
  // Output: cnt[2]_d
  NAND2_X1 U_c23 (.A(cnt_2_q), .B(w_inv_cnt_0_q), .Y(w_c23));
  // Output: cnt[2]_d
  NAND3_X1 U_c24 (.A(w_inv_cnt_2_q), .B(cnt_1_q), .C(cnt_0_q), .Y(w_c24));
  // Output: cnt[2]_d
  NAND2_X1 U_c25 (.A(cnt_2_q), .B(w_inv_cnt_1_q), .Y(w_c25));
  // Output: cnt[1]_d
  NAND2_X1 U_c26 (.A(w_inv_cnt_1_q), .B(cnt_0_q), .Y(w_c26));
  // Output: cnt[1]_d
  NAND2_X1 U_c27 (.A(cnt_1_q), .B(w_inv_cnt_0_q), .Y(w_c27));
  assign w_c28 = cnt_0_q; // Output: cnt[0]_d
  // Output: startup_d
  NAND2_X1 U_c29 (.A(w_inv_cnt_3_q), .B(startup_q), .Y(w_c29));
  // Output: startup_d
  NAND2_X1 U_c30 (.A(w_inv_cnt_1_q), .B(startup_q), .Y(w_c30));
  // Output: startup_d
  NAND2_X1 U_c31 (.A(w_inv_cnt_2_q), .B(startup_q), .Y(w_c31));
  // Output: startup_d
  NAND2_X1 U_c32 (.A(w_inv_cnt_0_q), .B(startup_q), .Y(w_c32));
  assign w_c33 = w_inv_c_DfT_en_LP; // Output: en_LP_d
  // Output: en_LP_d
  NAND3_X1 U_c34 (.A(c_DfT_en_PWM), .B(w_inv_cnt_3_q), .C(cnt_1_q), .Y(w_c34));
  // Output: en_LP_d
  NAND3_X1 U_c35 (.A(c_DfT_en_PWM), .B(w_inv_cnt_1_q), .C(cnt_0_q), .Y(w_c35));
  // Output: en_LP_d
  NAND3_X1 U_c36 (.A(c_DfT_en_PWM), .B(cnt_2_q), .C(w_inv_cnt_0_q), .Y(w_c36));
  // Output: en_LP_d
  NAND3_X1 U_c37 (.A(c_DfT_en_PWM), .B(cnt_3_q), .C(w_inv_cnt_2_q), .Y(w_c37));
  // Output: oc_ctrl_bgr_d
  wire w_c38_n0, w_c38_i0;
  NAND4_X1 U_c38_n0 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_en_PWM), .C(w_inv_c_DfT_oc_dig_VDD_0), .D(c_metalFix_invert_oc_defaults), .Y(w_c38_n0));
  INV_X1 U_c38_inv0 (.A(w_c38_n0), .Y(w_c38_i0));
  wire w_c38_n1, w_c38_i1;
  NAND2_X1 U_c38_n1 (.A(cnt_1_q), .B(oc_ctrl_bgr_q), .Y(w_c38_n1));
  INV_X1 U_c38_inv1 (.A(w_c38_n1), .Y(w_c38_i1));
  NAND2_X1 U_c38_root (.A(w_c38_i0), .B(w_c38_i1), .Y(w_c38));
  // Output: oc_ctrl_bgr_d
  wire w_c39_n0, w_c39_i0;
  NAND4_X1 U_c39_n0 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_oc_dig_VDD[0]), .C(w_inv_c_metalFix_invert_oc_defaults), .D(w_inv_cnt_3_q), .Y(w_c39_n0));
  ...
  NAND2_X1 U_c40_n1 (.A(cnt_3_q), .B(oc_ctrl_bgr_q), .Y(w_c40_n1));
  ...
  NAND4_X1 U_c43_n0 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_en_PWM), .C(w_inv_c_DfT_oc_dig_VDD_0), .D(c_metalFix_invert_oc_defaults), .Y(w_c43_n0));
  INV_X1 U_c43_inv0 (.A(w_c43_n0), .Y(w_c43_i0));
  wire w_c43_n1, w_c43_i1;
  NAND2_X1 U_c43_n1 (.A(cnt_3_q), .B(oc_ctrl_bgr_q), .Y(w_c43_n1));
  INV_X1 U_c43_inv1 (.A(w_c43_n1), .Y(w_c43_i1));
  NAND2_X1 U_c43_root (.A(w_c43_i0), .B(w_c43_i1), .Y(w_c43));
  // Output: oc_ctrl_bgr_d
  wire w_c44_n0, w_c44_i0;
  NAND4_X1 U_c44_n0 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_en_PWM), .C(w_inv_c_DfT_oc_dig_VDD_1), .D(w_inv_c_metalFix_invert_oc_defaults), .Y(w_c44_n0));
  INV_X1 U_c44_inv0 (.A(w_c44_n0), .Y(w_c44_i0));
  wire w_c44_n1, w_c44_i1;
  NAND3_X1 U_c44_n1 (.A(cnt_3_q), .B(cnt_2_q), .C(cnt_1_q), .Y(w_c44_n1));
  INV_X1 U_c44_inv1 (.A(w_c44_n1), .Y(w_c44_i1));
  NAND2_X1 U_c44_root (.A(w_c44_i0), .B(w_c44_i1), .Y(w_c44));
  // Output: oc_ctrl_bgr_d
  wire w_c45_n0, w_c45_i0;
  NAND4_X1 U_c45_n0 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_oc_dig_VDD_0), .C(c_metalFix_invert_oc_defaults), .D(w_inv_cnt_3_q), .Y(w_c45_n0));
  INV_X1 U_c45_inv0 (.A(w_c45_n0), .Y(w_c45_i0));
  wire w_c45_n1, w_c45_i1;
  NAND4_X1 U_c45_n1 (.A(w_inv_cnt_2_q), .B(w_inv_cnt_1_q), .C(w_inv_cnt_0_q), .D(w_inv_oc_ctrl_bgr_q), .Y(w_c45_n1));
  ...
  NAND4_X1 U_c47_n0 (.A(w_inv_c_DfT_en_LP), .B(c_DfT_en_PWM), .C(c_DfT_oc_dig_VDD[0]), .D(w_inv_c_metalFix_invert_oc_defaults), .Y(w_c47_n0));
  INV_X1 U_c47_inv0 (.A(w_c47_n0), .Y(w_c47_i0));
  wire w_c47_n1, w_c47_i1;
  NAND2_X1 U_c47_n1 (.A(cnt_1_q), .B(oc_ctrl_bgr_q), .Y(w_c47_n1));
  ...
  NAND4_X1 U_c49_n0 (.A(w_inv_c_DfT_en_LP), .B(w_inv_c_DfT_en_PWM), .C(w_inv_c_DfT_oc_dig_VDD_0), .D(c_metalFix_invert_oc_defaults), .Y(w_c49_n0));
  ...
  NAND2_X1 U_c50_n1 (.A(cnt_0_q), .B(oc_ctrl_bgr_q), .Y(w_c50_n1));
  ...
  NAND2_X1 U_c51_n1 (.A(cnt_2_q), .B(oc_ctrl_bgr_q), .Y(w_c51_n1));
  ...
  NAND4_X1 U_out_oc_select (.A(w_c0), .B(w_c1), .C(w_c2), .D(w_c3), .Y(oc_select));
  wire w_out_oc_ctrl_cp_ch0;
  NAND4_X1 U_out_oc_ctrl_cp_ch0 (.A(w_c4), .B(w_c5), .C(w_c6), .D(w_c7), .Y(w_out_oc_ctrl_cp_ch0));
  ...
  NAND2_X1 U_out_oc_ctrl_cp_ch1 (.A(w_c8), .B(w_c9), .Y(w_out_oc_ctrl_cp_ch1));
  ...
  NAND4_X1 U_out_en_lowFreq_ch0 (.A(w_c10), .B(w_c11), .C(w_c12), .D(w_c13), .Y(w_out_en_lowFreq_ch0));
  ...
  NAND4_X1 U_out_en_lowFreq_ch1 (.A(w_c14), .B(w_c15), .C(w_c16), .D(w_c17), .Y(w_out_en_lowFreq_ch1));
  ...
  INV_X1 U_out_en_lowFreq_ch2 (.A(w_c18), .Y(w_out_en_lowFreq_ch2));
  ...
  NAND4_X1 U_out_cnt_3_d (.A(w_c19), .B(w_c20), .C(w_c21), .D(w_c22), .Y(cnt_3_d));
  NAND3_X1 U_out_cnt_2_d (.A(w_c23), .B(w_c24), .C(w_c25), .Y(cnt_2_d));
  NAND2_X1 U_out_cnt_1_d (.A(w_c26), .B(w_c27), .Y(cnt_1_d));
  INV_X1   U_out_cnt_0_d (.A(w_c28), .Y(cnt_0_d));
  NAND4_X1 U_out_startup_d (.A(w_c29), .B(w_c30), .C(w_c31), .D(w_c32), .Y(startup_d));
  wire w_out_en_LP_d_ch0;
  NAND4_X1 U_out_en_LP_d_ch0 (.A(w_c33), .B(w_c34), .C(w_c35), .D(w_c36), .Y(w_out_en_LP_d_ch0));
  wire w_out_en_LP_d_inv_ch0;
  INV_X1 U_out_en_LP_d_inv0 (.A(w_out_en_LP_d_ch0), .Y(w_out_en_LP_d_inv_ch0));
  wire w_out_en_LP_d_ch1;
  INV_X1 U_out_en_LP_d_ch1 (.A(w_c37), .Y(w_out_en_LP_d_ch1));
  ...
  NAND4_X1 U_out_oc_ctrl_bgr_d_ch0 (.A(w_c38), .B(w_c18), .C(w_c39), .D(w_c40), .Y(w_out_oc_ctrl_bgr_d_ch0));
  ...
  NAND4_X1 U_out_oc_ctrl_bgr_d_ch1 (.A(w_c11), .B(w_c41), .C(w_c12), .D(w_c0), .Y(w_out_oc_ctrl_bgr_d_ch1));
  ...
  NAND4_X1 U_out_oc_ctrl_bgr_d_ch2 (.A(w_c1), .B(w_c13), .C(w_c14), .D(w_c42), .Y(w_out_oc_ctrl_bgr_d_ch2));
  ...
  NAND4_X1 U_out_oc_ctrl_bgr_d_ch3 (.A(w_c15), .B(w_c43), .C(w_c44), .D(w_c45), .Y(w_out_oc_ctrl_bgr_d_ch3));
  ...
  NAND4_X1 U_out_oc_ctrl_bgr_d_ch4 (.A(w_c46), .B(w_c47), .C(w_c48), .D(w_c49), .Y(w_out_oc_ctrl_bgr_d_ch4));
  ...
  NAND4_X1 U_out_oc_ctrl_bgr_d_ch5 (.A(w_c17), .B(w_c50), .C(w_c10), .D(w_c51), .Y(w_out_oc_ctrl_bgr_d_ch5));
